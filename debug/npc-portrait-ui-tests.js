...
assert(css.includes('.world-signal {') && css.includes('left: 18px') && css.includes('bottom: 18px'), 'world notices should anchor in the lower-left corner')
assert(game.includes('scheduleWorldSignalAutoHide(selected)') && game.includes('}, 5000);'), 'world notices should automatically hide after five seconds')
