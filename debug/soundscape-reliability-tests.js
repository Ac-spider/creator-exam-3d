...
import { Soundscape, SOUND_MANIFEST } from '../public/js/soundscape.js'
...
assert.equal(played[0].src, SOUND_MANIFEST.creationCompile.src)
assert.ok(played[0].volume > 0 && played[0].volume <= 1, 'sound volume should be clamped')
